...
const GeneralPractitioner: React.FC<SvgProps> = (props) => (
  <Svg width={46} height={46} viewBox="0 0 46 46" fill="none" {...props}>
    ...
    <G mask="url(#prefix__a)">
      ...
      <Path d="M25.139 22.859l12.229-12.23 3.924 3.925-12.229 12.23-3.924-3.925z" fill="#D5E7FF" />
...
export default React.memo(GeneralPractitioner);
